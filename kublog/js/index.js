...
function(e, t, n) {
    ...
    t.preload = function(e) {
        if (!d || !m) return;
        p[e = e || "default"] || (p[e] = !0, o.loader.add('../kublog'+i.cdnPath + "audios/" + e + ".mp3", {
            type: "xhr",
...
function(e, t, n) {
    ...
    t.preInit = function(e) {
        d = e,
        o.loader.add('../kublog'+r.assetPath + "images/female.glb", {
            type: "any",
            weight: 1,
            hasLoading: !0,
        ...
        o.loader.add('../kublog'+r.assetPath + "images/buffers.buf", {
            type: "xhr",
            responseType: "arraybuffer",
            weight: 1,
            onLoad: S
...
function(e, t, n) {
    ...
    t.preInit = function(e) {
        u = e,
        (l = new s.Texture(i.loader.add("../kublog"+r.cdnPath + "images/sprite.png").content)).magFilter = l.minFilter = s.LinearFilter,
        l.needsUpdate = !0
    },
    t.init = function() {
        o.init(u);
...
function(e, t, n) {
    ...
    v.preInit = function() {
        var e = this;
        o.loader.add(("../kublog"+r.cdnPath + "images/" + this.id + "/desktop_home_thumb.png"), {
            onLoad: function(t) {
...
function(e, t, n) {
    ...
    t.preInit = function(e) {
        c = e,
        (f = new i.Texture(u.loader.add('../kublog'+s.cdnPath + "images/floor.jpg").content)).wrapS = f.wrapT = i.RepeatWrapping,
...
function(e, t, n) {
    ...
    t.preInit = function(e) {
        ...
        (_ = new i.Texture(l.loader.add('../kublog'+c.cdnPath + "images/floor.png").content)).wrapS = _.wrapT = i.MirroredRepeatWrapping,
...
function(e, t, n) {
    ...
    t.preInit = function(e) {
        ...
        o.loader.add('../kublog'+r.assetPath + "images/animation.glb", {
            type: "any",
            weight: 1,
            hasLoading: !0,
        ...
        var a ="../kublog"+ r.assetPath + "images/" + (i.isMobile ? "low/": "high/");
